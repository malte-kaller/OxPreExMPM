...
% Configure SPM for non-GUI execution
spm('defaults','fmri');
...
% Run hMRI: no B1 correction
outdir = strcat(directory, filesep, 'hMRI_Results_noB1mapping');
mkdir(outdir);
clear matlabbatch
...
% Run hMRI: pre-processed B1 correction
