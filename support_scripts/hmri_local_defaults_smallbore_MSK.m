function hmri_local_defaults_smallbore_MSK
...
hmri_def.centre = 'BSB_smallbore' ; % 'fil', 'lren', 'crc', 'sciz', 'cbs', ...
hmri_def.scanner = '7Tsmallbore' ; % e.g. 'prisma', 'allegra', 'terra', 'achieva', ...
...
hmri_def.TPM = '/opt/fmrib/hMRI-Toolbox/etpm/eTPM.nii';
...
% ADVANCED USER ONLY. 
hmri_def.fullOLS = false; %DP edit
...
hmri_def.PDproc.T2scorr = 0; % to correct A map for T2*-weighting bias 
...
% ADVANCED USER ONLY.
%--------------------------------------------------------------------------
hmri_def.qMRI_maps_thresh.R1       = 15000; % 1000*[s-1]
...
hmri_def.qMRI_maps_thresh.MTR      = 100;
hmri_def.qMRI_maps_thresh.MTR_synt = 100;
