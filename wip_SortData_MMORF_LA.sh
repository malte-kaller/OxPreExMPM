...
#This script sorts the data for the MMORF registration
...
outDIR=$projectDIR/MMORF_data_LA
...
for subject in $subjectList; do
    ...
    flirt -in $in_MD -ref "$out_T2w" \
      -out "$out_MD" -omat "$outDIR/${subject}/DTI/DTI_to_T2w.mat" \
